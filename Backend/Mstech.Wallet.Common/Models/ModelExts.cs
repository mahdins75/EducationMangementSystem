...
namespace Common.Models {
    ...
    public static class ModelExts {
        ...
        public static bool? GetFormBoolOrNull(this IEnumerable<KeyValuePair<string, StringValues>> values, string key)
            => bool.TryParse(GetFormValue(values, key), out var val) ? val : null;
        ...
        public static short GetFormInt16(this IEnumerable<KeyValuePair<string, StringValues>> values, string key)
           => short.TryParse(GetFormValue(values, key), out var val) ? val : default(short);
