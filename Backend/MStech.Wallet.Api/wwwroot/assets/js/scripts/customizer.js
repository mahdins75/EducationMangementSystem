...
(function (window, document, $) {
	...
	$('#checkboxSwitchTheme').on('change', function () {
		if ($(this).is(':checked')) {
			// Checkbox is checked, click on Element 1
			$('#radio-dark').trigger('click');
		} else {
			// Checkbox is unchecked, click on Element 2
			$('#radio-semi-dark').trigger('click');
		}
	});
